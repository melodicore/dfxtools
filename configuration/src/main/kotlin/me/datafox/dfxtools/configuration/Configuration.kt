...
class Configuration() {
     ...
     * @param keys [ConfigurationKeys][ConfigurationKey] to be copied from [configuration], or empty
     *   is all keys should be copied. Keys that are not present will be ignored.
     */
