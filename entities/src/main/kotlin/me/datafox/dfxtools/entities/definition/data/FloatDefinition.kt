...
import me.datafox.dfxtools.entities.type.FloatType

@Serializable
@SerialName(FloatType.ID)
data class FloatDefinition(override val id: String, override val saved: Boolean, override val value: Float) :
