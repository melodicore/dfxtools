 ...
 * @author datafox
 */
class ModifiableValue(override val handle: Handle, value: BigDecimal = BigDecimal.ZERO) : AbstractObservableObserver(), Handled, Value {
    ...
    val modifiers: MutableSet<Modifier> by ObservableSetProperty()
